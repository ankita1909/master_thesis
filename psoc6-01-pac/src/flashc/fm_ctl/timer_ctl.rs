...
pub struct AUTO_SEQUENCE_R(crate::FieldReader<bool, bool>);
impl AUTO_SEQUENCE_R {
    pub(crate) fn new(bits: bool) -> Self {
        AUTO_SEQUENCE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for AUTO_SEQUENCE_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct AUTO_SEQUENCE_W<'a> {
    w: &'a mut W,
}
impl<'a> AUTO_SEQUENCE_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 24 - 1': Starts1 the HV automatic sequencing Cleared by HW"]
    #[inline(always)]
    pub fn auto_sequence(&mut self) -> AUTO_SEQUENCE_W {
        AUTO_SEQUENCE_W { w: self }
    }
    #[doc = "Bit 25 - 1 during pre-program operation"]
    #[inline(always)]
