...
pub struct PW_SEQ1_R(crate::FieldReader<u16, u16>);
impl PW_SEQ1_R {
    pub(crate) fn new(bits: u16) -> Self {
        PW_SEQ1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PW_SEQ1_R {
...
pub struct PW_SEQ2_PRE_R(crate::FieldReader<u16, u16>);
impl PW_SEQ2_PRE_R {
    pub(crate) fn new(bits: u16) -> Self {
        PW_SEQ2_PRE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PW_SEQ2_PRE_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
