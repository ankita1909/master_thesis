...
pub struct CMD_RESP_INDX_R(crate::FieldReader<u8, u8>);
impl CMD_RESP_INDX_R {
    pub(crate) fn new(bits: u8) -> Self {
        CMD_RESP_INDX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CMD_RESP_INDX_R {
