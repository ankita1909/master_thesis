...
pub struct MAX_CUR_33V_R(crate::FieldReader<u8, u8>);
impl MAX_CUR_33V_R {
    pub(crate) fn new(bits: u8) -> Self {
        MAX_CUR_33V_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_CUR_33V_R {
...
pub struct MAX_CUR_30V_R(crate::FieldReader<u8, u8>);
impl MAX_CUR_30V_R {
    pub(crate) fn new(bits: u8) -> Self {
        MAX_CUR_30V_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_CUR_30V_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct MAX_CUR_18V_R(crate::FieldReader<u8, u8>);
impl MAX_CUR_18V_R {
    pub(crate) fn new(bits: u8) -> Self {
        MAX_CUR_18V_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_CUR_18V_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
