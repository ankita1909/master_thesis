...
pub struct SW_RST_CMD_R(crate::FieldReader<bool, bool>);
impl SW_RST_CMD_R {
    pub(crate) fn new(bits: bool) -> Self {
        SW_RST_CMD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SW_RST_CMD_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SW_RST_DAT_R(crate::FieldReader<bool, bool>);
impl SW_RST_DAT_R {
    pub(crate) fn new(bits: bool) -> Self {
        SW_RST_DAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SW_RST_DAT_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
