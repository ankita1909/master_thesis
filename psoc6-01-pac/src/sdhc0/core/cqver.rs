...
pub struct EMMC_VER_SUFFIX_R(crate::FieldReader<u8, u8>);
impl EMMC_VER_SUFFIX_R {
    pub(crate) fn new(bits: u8) -> Self {
        EMMC_VER_SUFFIX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EMMC_VER_SUFFIX_R {
...
pub struct EMMC_VER_MINOR_R(crate::FieldReader<u8, u8>);
impl EMMC_VER_MINOR_R {
    pub(crate) fn new(bits: u8) -> Self {
        EMMC_VER_MINOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EMMC_VER_MINOR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct EMMC_VER_MAJOR_R(crate::FieldReader<u8, u8>);
impl EMMC_VER_MAJOR_R {
    pub(crate) fn new(bits: u8) -> Self {
        EMMC_VER_MAJOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EMMC_VER_MAJOR_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
