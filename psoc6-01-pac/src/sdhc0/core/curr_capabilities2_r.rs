...
pub struct MAX_CUR_VDD2_18V_R(crate::FieldReader<u8, u8>);
impl MAX_CUR_VDD2_18V_R {
    pub(crate) fn new(bits: u8) -> Self {
        MAX_CUR_VDD2_18V_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for MAX_CUR_VDD2_18V_R {
