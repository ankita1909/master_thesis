...
pub struct SPEC_VERSION_NUM_R(crate::FieldReader<u8, u8>);
impl SPEC_VERSION_NUM_R {
    pub(crate) fn new(bits: u8) -> Self {
        SPEC_VERSION_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SPEC_VERSION_NUM_R {
...
pub struct VENDOR_VERSION_NUM_R(crate::FieldReader<u8, u8>);
impl VENDOR_VERSION_NUM_R {
    pub(crate) fn new(bits: u8) -> Self {
        VENDOR_VERSION_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for VENDOR_VERSION_NUM_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
