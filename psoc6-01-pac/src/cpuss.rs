...
pub struct RegisterBlock {
    ...
    pub cm4_ctl: crate::Reg<cm4_ctl::CM4_CTL_SPEC>,
    _reserved4: [u8; 0xf0],
    #[doc = "0x100 - CM4 interrupt 0 status"]
    pub cm4_int0_status: crate::Reg<cm4_int0_status::CM4_INT0_STATUS_SPEC>,
    #[doc = "0x104 - CM4 interrupt 1 status"]
    pub cm4_int1_status: crate::Reg<cm4_int1_status::CM4_INT1_STATUS_SPEC>,
    #[doc = "0x108 - CM4 interrupt 2 status"]
    pub cm4_int2_status: crate::Reg<cm4_int2_status::CM4_INT2_STATUS_SPEC>,
    #[doc = "0x10c - CM4 interrupt 3 status"]
    pub cm4_int3_status: crate::Reg<cm4_int3_status::CM4_INT3_STATUS_SPEC>,
    #[doc = "0x110 - CM4 interrupt 4 status"]
    pub cm4_int4_status: crate::Reg<cm4_int4_status::CM4_INT4_STATUS_SPEC>,
    #[doc = "0x114 - CM4 interrupt 5 status"]
    pub cm4_int5_status: crate::Reg<cm4_int5_status::CM4_INT5_STATUS_SPEC>,
    #[doc = "0x118 - CM4 interrupt 6 status"]
    pub cm4_int6_status: crate::Reg<cm4_int6_status::CM4_INT6_STATUS_SPEC>,
    #[doc = "0x11c - CM4 interrupt 7 status"]
    pub cm4_int7_status: crate::Reg<cm4_int7_status::CM4_INT7_STATUS_SPEC>,
    _reserved12: [u8; 0xe0],
    ...
    pub cm4_nmi_ctl: [crate::Reg<cm4_nmi_ctl::CM4_NMI_CTL_SPEC>; 4],
    _reserved14: [u8; 0xb0],
    ...
    pub cm0_int0_status: crate::Reg<cm0_int0_status::CM0_INT0_STATUS_SPEC>,
    #[doc = "0x1104 - CM0+ interrupt 1 status"]
    pub cm0_int1_status: crate::Reg<cm0_int1_status::CM0_INT1_STATUS_SPEC>,
    #[doc = "0x1108 - CM0+ interrupt 2 status"]
    pub cm0_int2_status: crate::Reg<cm0_int2_status::CM0_INT2_STATUS_SPEC>,
    #[doc = "0x110c - CM0+ interrupt 3 status"]
    pub cm0_int3_status: crate::Reg<cm0_int3_status::CM0_INT3_STATUS_SPEC>,
    #[doc = "0x1110 - CM0+ interrupt 4 status"]
    pub cm0_int4_status: crate::Reg<cm0_int4_status::CM0_INT4_STATUS_SPEC>,
    #[doc = "0x1114 - CM0+ interrupt 5 status"]
    pub cm0_int5_status: crate::Reg<cm0_int5_status::CM0_INT5_STATUS_SPEC>,
    #[doc = "0x1118 - CM0+ interrupt 6 status"]
    pub cm0_int6_status: crate::Reg<cm0_int6_status::CM0_INT6_STATUS_SPEC>,
    #[doc = "0x111c - CM0+ interrupt 7 status"]
    pub cm0_int7_status: crate::Reg<cm0_int7_status::CM0_INT7_STATUS_SPEC>,
    ...
    pub cm0_nmi_ctl: [crate::Reg<cm0_nmi_ctl::CM0_NMI_CTL_SPEC>; 4],
    _reserved29: [u8; 0xb0],
    ...
    pub ram0_status: crate::Reg<ram0_status::RAM0_STATUS_SPEC>,
    _reserved33: [u8; 0x38],
    ...
    pub ram1_status: crate::Reg<ram1_status::RAM1_STATUS_SPEC>,
    ...
    pub ram2_status: crate::Reg<ram2_status::RAM2_STATUS_SPEC>,
    ...
    pub product_id: crate::Reg<product_id::PRODUCT_ID_SPEC>,
    _reserved44: [u8; 0x0c],
    ...
    pub cal_sup_set: crate::Reg<cal_sup_set::CAL_SUP_SET_SPEC>,
    #[doc = "0x1804 - Calibration support clear and reset"]
    pub cal_sup_clr: crate::Reg<cal_sup_clr::CAL_SUP_CLR_SPEC>,
    _reserved51: [u8; 0x07f8],
    #[doc = "0x2000 - CM0+ protection context control"]
    pub cm0_pc_ctl: crate::Reg<cm0_pc_ctl::CM0_PC_CTL_SPEC>,
    _reserved52: [u8; 0x3c],
    ...
    pub cm0_pc1_handler: crate::Reg<cm0_pc1_handler::CM0_PC1_HANDLER_SPEC>,
    #[doc = "0x2048 - CM0+ protection context 2 handler"]
    pub cm0_pc2_handler: crate::Reg<cm0_pc2_handler::CM0_PC2_HANDLER_SPEC>,
    #[doc = "0x204c - CM0+ protection context 3 handler"]
    pub cm0_pc3_handler: crate::Reg<cm0_pc3_handler::CM0_PC3_HANDLER_SPEC>,
    _reserved56: [u8; 0x74],
    ...
    pub cm0_system_int_ctl: [crate::Reg<cm0_system_int_ctl::CM0_SYSTEM_INT_CTL_SPEC>; 1023],
    _reserved60: [u8; 0x1004],
    #[doc = "0xa000..0xaffc - CM4 system interrupt control"]
    pub cm4_system_int_ctl: [crate::Reg<cm4_system_int_ctl::CM4_SYSTEM_INT_CTL_SPEC>; 1023],
}
...
#[doc = "RAM 0 control"]
pub mod ram0_ctl0;
#[doc = "RAM0_STATUS register accessor: an alias for `Reg<RAM0_STATUS_SPEC>`"]
...
#[doc = "RAM 1 control"]
pub mod ram1_ctl0;
#[doc = "RAM1_STATUS register accessor: an alias for `Reg<RAM1_STATUS_SPEC>`"]
...
#[doc = "RAM 2 control"]
pub mod ram2_ctl0;
#[doc = "RAM2_STATUS register accessor: an alias for `Reg<RAM2_STATUS_SPEC>`"]
...
#[doc = "ECC control"]
pub mod ecc_ctl;
#[doc = "PRODUCT_ID register accessor: an alias for `Reg<PRODUCT_ID_SPEC>`"]
...
pub mod mbist_stat;
#[doc = "CAL_SUP_SET register accessor: an alias for `Reg<CAL_SUP_SET_SPEC>`"]
pub type CAL_SUP_SET = crate::Reg<cal_sup_set::CAL_SUP_SET_SPEC>;
#[doc = "Calibration support set and read"]
pub mod cal_sup_set;
#[doc = "CAL_SUP_CLR register accessor: an alias for `Reg<CAL_SUP_CLR_SPEC>`"]
pub type CAL_SUP_CLR = crate::Reg<cal_sup_clr::CAL_SUP_CLR_SPEC>;
#[doc = "Calibration support clear and reset"]
pub mod cal_sup_clr;
#[doc = "CM0_PC_CTL register accessor: an alias for `Reg<CM0_PC_CTL_SPEC>`"]
...
#[doc = "CM0_PC1_HANDLER register accessor: an alias for `Reg<CM0_PC1_HANDLER_SPEC>`"]
...
#[doc = "CM0_PC2_HANDLER register accessor: an alias for `Reg<CM0_PC2_HANDLER_SPEC>`"]
...
#[doc = "CM0_PC3_HANDLER register accessor: an alias for `Reg<CM0_PC3_HANDLER_SPEC>`"]
...
#[doc = "CM0_SYSTEM_INT_CTL register accessor: an alias for `Reg<CM0_SYSTEM_INT_CTL_SPEC>`"]
...
#[doc = "CM4_SYSTEM_INT_CTL register accessor: an alias for `Reg<CM4_SYSTEM_INT_CTL_SPEC>`"]
