...
pub struct RegisterBlock {
    ...
    pub timeout_ctl: crate::Reg<timeout_ctl::TIMEOUT_CTL_SPEC>,
    _reserved1: [u8; 0x1c],
    ...
    pub clock_ctl: [crate::Reg<clock_ctl::CLOCK_CTL_SPEC>; 256],
    #[doc = "0x1000..0x1400 - Divider control (for 8.0 divider)"]
    pub div_8_ctl: [crate::Reg<div_8_ctl::DIV_8_CTL_SPEC>; 256],
    #[doc = "0x1400..0x1800 - Divider control (for 16.0 divider)"]
    pub div_16_ctl: [crate::Reg<div_16_ctl::DIV_16_CTL_SPEC>; 256],
    #[doc = "0x1800..0x1c00 - Divider control (for 16.5 divider)"]
    pub div_16_5_ctl: [crate::Reg<div_16_5_ctl::DIV_16_5_CTL_SPEC>; 256],
    #[doc = "0x1c00..0x1ffc - Divider control (for 24.5 divider)"]
    pub div_24_5_ctl: [crate::Reg<div_24_5_ctl::DIV_24_5_CTL_SPEC>; 255],
    _reserved8: [u8; 0x04],
...
pub struct TR_GR {
    ...
    pub tr_ctl: [crate::Reg<self::tr_gr::tr_ctl::TR_CTL_SPEC>; 256],
}
#[doc = r"Register block"]
#[doc = "Trigger group"]
pub mod tr_gr;
...
pub struct TR_1TO1_GR {
    #[doc = "0x00..0x400 - Trigger control register"]
    pub tr_ctl: [crate::Reg<self::tr_1to1_gr::tr_ctl::TR_CTL_SPEC>; 256],
}
#[doc = r"Register block"]
