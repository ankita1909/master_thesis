#![doc = "Peripheral access API for PSOC6_02 microcontrollers (generated using svd2rust v0.19.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl SCB5 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const scb5::RegisterBlock = 0x4065_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const scb5::RegisterBlock {
        Self::PTR
    }
}
impl Deref for SCB5 {
    type Target = scb5::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
